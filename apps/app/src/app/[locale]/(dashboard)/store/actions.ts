...
export async function createVariant(
  ...
  const { data, error: insertErr } = await supabase
    ...
    .insert({
      ...
      size_ar: parsed.data.size_ar ?? null,
      size_en: parsed.data.size_en ?? null,
      color: parsed.data.color ?? null,
      color_ar: parsed.data.color_ar ?? null,
      color_en: parsed.data.color_en ?? null,
...
export async function updateVariant(
  ...
  const { error: updErr } = await supabase
    ...
    .update({
      ...
      size_ar: patch.size_ar ?? null,
      size_en: patch.size_en ?? null,
      color: patch.color ?? null,
      color_ar: patch.color_ar ?? null,
      color_en: patch.color_en ?? null,
